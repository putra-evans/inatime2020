    ...
    <div class="dark-overlay p-t-b-80" data-overlay-opacity="0">
        <div class="container">
            <div class="row">
                ...
                <h3 class="text-center emphasis style23" style="font-family: arial" data-in-effect="fadeInUp">How To Registration</h3>
...
<!--							   <tr><td colspan="4" align="center" bgcolor="#00882c"><span class="style22">REGISTRATION FEE OF INA TIME 2020</span></td>-->
<!--							   </tr>-->
<!--  <tr>-->
...
11. Transaksi Anda telah selesai.</td>
							   ...
							   <tr><td bgcolor="#00882c"><span class="style22">Pembayaran BNI Virtual Account dengan mobile banking BNI</span></td>
							   </tr><tr><td>
							   ...
							   <tr><td bgcolor="#00882c"><span class="style22">Pembayaran BNI Virtual Account dengan BNI sms banking</span></td>
							   </tr>
							   <tr><td>
   ...
   <!-- 				    <p style="font-size: 12px;">please write: hotel name, room type, bed type, check in, check out</p>-->
   <!-- 			    </div>-->
