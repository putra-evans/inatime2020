...
<section class="portfolio-header parallax parallax1"
    style="background: url('img/tourism/jam.jpg') 50% 0 no-repeat fixed;">
                ...
                <div class="container">
                    ...
                    <div class="tab-content">
                        <div id="menu" style="width:700px" class="tab-pane fade in active">
                            ...
                            <form class="form-group" method="POST" action="daftar_simposium_aksi_beta.php"
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select type="text" name="id_simposium" id="id_simposium" class="form-control"
                                            ...
                                            // KONDISI IF UNTUK MENAMPILKAN HARGA SEBELUM DAN HARGA SESUDAH
                                                ...
                                                while($row=mysql_fetch_array($result)){
                                                    ...
                                                    $jsArray .="dtpgj ['".$row['id_simposium']."']= {hargasesudah :'" . addslashes($row['hargasesudah'])."'};\n";
                                                }
                                                // ------------------------------------------------------------------
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="hargasesudah" id="hargasesudah" placeholder="Harga"
                                            class="form-control">
                                        <input type="text" name="asal_cabang" placeholder="City" class="form-control"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="no_telpon" placeholder="Phone Number"
                                            class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="text-left">
                                    <input type="submit" name="simpan" value="Register"
                                        class="btn btn-colored btn-md text-center"><br>
                                </div>
                            </form>
                            <br>
...
<script type="text/javascript">
    ...
    (id_simposium)
    {
    document.getElementById('hargasesudah').value
    =
    dtpgj[id_simposium].hargasesudah;
    };
</script>