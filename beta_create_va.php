...
// From Kami
    $id_daftar = date('dmYhis');
    $total_seluruh = 5000000;
    $nama_lengkap = 'Ririn Febriani';
    $email ='putraevans001@gmail.com';
    $no_telpon = '0819629431';

$data_asli = array(
    'type' => "createbilling",
    'client_id' => $client_id,
    'trx_id' => $id_daftar, // fill with Billing ID
